...
class SectionTextShimmerEffect extends StatelessWidget {
 ...
 Future showCelebrationModal(
      BuildContext context, CelebrationData data, Function toggleCelebrationShown) async {
                          ...
                          child: Center(
                            child: Text(
                              ...
                              style: fontThemeClass.body(context,
                                  fontWeight: FontWeight.w600,  color: context.colorScheme.secondaryWhiteColor),
                            ),
                          ),
                        ),
                      ),
 ...
 Future showWelcomPopUp(BuildContext context,{required Function toggleisNewUser ,required String username}) async {
    FontThemeClass fontThemeClass = FontThemeClass();
